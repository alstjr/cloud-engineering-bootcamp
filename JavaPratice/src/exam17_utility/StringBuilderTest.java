...
public class StringBuilderTest {
	public static void main(String[] args) {
		...
		System.out.println("6. 왼쪽 공백제거: " + s2.stripTrailing()); //       world

		System.out.println("7. 문자열 연결:" + (s+ "world")); // + 연결연산자
		System.out.println("7. 문자열 연결:" + s.concat("world")); // concat 메서드
		...
		System.out.println("11. 문자열 비교: " + x.equalsIgnoreCase(x3)); // true
		...
		// 비문자열 ====> 문자열 valueOf가 static 메서드 이기 때문에
		// 10 => "10", 3.15 =>"3.15", true => "true"
		System.out.println("12. 비문자열 ====> 문자열 : " + String.valueOf(10)); // "10"
		System.out.println("12. 비문자열 ====> 문자열 : " + String.valueOf(3.14)); // "3.14"
		System.out.println("12. 비문자열 ====> 문자열 : " + String.valueOf(true)); // "true"
		System.out.println("12. 비문자열 ====> 문자열 : " + String.valueOf(new char[] {'A','B'})); // "AB"
