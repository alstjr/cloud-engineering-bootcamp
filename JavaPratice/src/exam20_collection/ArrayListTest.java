...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		...
		list.remove(new Integer(1000)); // 값으로 삭제 Object wrapper 클래스로 줘야 값으로 인식한다
		...
		// 생성방법2 - Arrays 클래스이용
		List<String> list4 = Arrays.asList("A","B","B","C"); // fixed-size로 만들어서 추가 불가, 가변인자
